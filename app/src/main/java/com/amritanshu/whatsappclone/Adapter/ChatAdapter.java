...
public class ChatAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(fromWhichActivity.equals("ChatDetail"))
        {
        ...
        else
        {
            SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy hh:mm");
            String dateString = formatter.format(new Date(Long.parseLong(messageModel.getTimestamp().toString())));
            ((ReceiverViewHodler)holder).receiveMsg.setText(messageModel.getMessage());
            ((ReceiverViewHodler)holder).receiveTime.setText(dateString);
        }
    }
